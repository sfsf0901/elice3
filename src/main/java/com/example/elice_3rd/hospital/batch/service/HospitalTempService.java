package com.example.elice_3rd.hospital.batch.service;
...
import com.example.elice_3rd.hospital.batch.repository.HospitalTempRepository;
...
public class HospitalTempService {

    private final HospitalTempRepository hospitalTempRepository;
    ...
    public List<HospitalTemp> findAllByYkihoIn(List<String> ykihoList) {
        return hospitalTempRepository.findAllByYkihoIn(ykihoList);
    }

    public List<HospitalTemp> findDistinctHospitals() {
        return hospitalTempRepository.findDistinctByYkiho();
    }

    public List<HospitalTemp> findAll() {
        return hospitalTempRepository.findAll();
    }
}
